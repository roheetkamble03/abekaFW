...
public @interface Calendar {
    ...
    String taskGridText = "xpath=((//div[@class='fc-content-skeleton']/table)[%s]/descendant::a/descendant::span[@class='fc-title'])[%s]";
    String moreEventsLink = "xpath=(((//div[@class='fc-content-skeleton']/table/tbody)[%s]/descendant::tr[%s])/descendant::a/descendant::span[@class='fc-title'])[%s]";
